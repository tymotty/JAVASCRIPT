...
//Implemente um objeto taskManager com 3 métodos: add(name) — adiciona tarefa com status 'pending'; complete(name) — muda o status para 'done'; summary() — retorna um objeto com pending e done (arrays de nomes).


//8. Agrupador de alunos por nota
